...
syms PLL_int thetapll U_dc Udc_int i_gd i_gq Id_grid_int Iq_grid_int P_ref Q_ref                 
%直流侧潮流
f   = 60;
w_g = 2*pi*f;
...
[PLL_int thetapll U_dc Udc_int i_gd i_gq Id_grid_int Iq_grid_int P_ref Q_ref]...
...
for i = 1:n
    ...
    [dxdt_perturbed, y_perturbed] = Copy_of_VOC(0, x_perturbed, u_ss);
    [dxdt_nominal, y_nominal] = Copy_of_VOC(0, x_ss, u_ss);
...
for i = 1:m
    ...
    [dxdt_perturbed, y_perturbed] = Copy_of_VOC(0, x_ss, u_perturbed);
    [dxdt_nominal, y_nominal] = Copy_of_VOC(0, x_ss, u_ss);
