function dotx = PMSG(t,x,v_w, i_gqref)
%%%%%%%%%%%%%%%%%%%%%%%%%% Rename %%%%%%%%%%%%%%%%%%%%%%%%
omega_m = x(1);
Psi_sq       = x(2);
Psi_sd       = x(3);
...
ig_alphabeta = (1/Ibase)*Tg_dq_alphabeta*[i_gd;i_gq];

i_galpha = ig_alphabeta(1);
i_gbeta = ig_alphabeta(2);
...
%%%%%%%%%%%%%%%%%%%%%%% Differential %%%%%%%%%%%%%%%%%%%%%
    ...
    dotx = [
        ...
        PLL_int + Kp_PLL*(u_gq/Vbase - ugq_ref)
        (P_s - P_dc)/(C_dc*U_dc);
        U_dc - U_dcref;
