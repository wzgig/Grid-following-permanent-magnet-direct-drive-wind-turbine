...
eqn17 = i_galpha == i_alpha;
eqn18 = i_gbeta == i_beta;
...
[omega_m, Psi_sq, Psi_sd, Id_stator_int, Iq_stator_int, Speed_int,...
    ...
    v_w, i_gqref]...
                      ...
                      eqn7,eqn8,eqn11,eqn12,eqn13,eqn14,eqn15,eqn16, ...
                      eqn17,eqn18]),...
                      [omega_m Psi_sq Psi_sd Id_stator_int Iq_stator_int Speed_int ...
                      u_sd u_sq U_dc Udc_int i_gd i_gq Id_grid_int Iq_grid_int ...
                      v_w i_gqref],...
...
[t,x] = ode45(@(t,x) PMSG(t,x,v_w, i_gqref),tspan,double(inistate),options);
