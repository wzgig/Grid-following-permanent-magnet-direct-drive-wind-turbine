...
eqn11 = (P_s - P_g)/(C_dc*U_dc) == 0;
eqn12 = U_dc - U_dcref == 0;
eqn13 = (u_gd - v_g_d + w_g*L_g*i_gq)/L_g == 0;
eqn14 = (u_gq - v_g_q - w_g*L_g*i_gd)/L_g == 0;
...
[t,x] = ode45(@(t,x) wangce(t,x),tspan,double(inistate),options);
